        ...
        <div className="section-1">
          ...
          <div className="logo-cont">
            ...
            <div>
              <GatsbyImage
                image={getImage(
                  data.relationships.field_about_us_decimo_logo.localFile
                )}
                alt="alt"
        ...
        <div className="aboutus-text-container">
          ...
          <div className="aboutus-author">
            <p className="about-name">
              {data.field_about_us_author_and_charge[0]}
            </p>
            <p className="about-line">|</p>
            <span className="clear-text">
              {data.field_about_us_author_and_charge[1]}
            </span>
          </div>
          ...
          <div className="icons-container">
            <a href={data.field_about_us_link[0].uri} target="_blank">
              ...
              <GatsbyImage
                image={getImage(
                  data.relationships.field_about_us_icons[0].localFile
                )}
                alt="alt"
