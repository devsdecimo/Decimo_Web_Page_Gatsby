...
function FormBlogPage() {
  ...
  const {
    field_title_form: titleForm,
    field_name_Form: nameForm,
    field_name_label: nameLabel,
    field_email_form: emailForm,
    field_email_label: emailLabel,
    field_message_form: messageForm,
    field_message_label: messageLabel,
    field_button_form: buttonForm,
  } = data.allNodeContactForm.nodes[0];
      ...
      <div className="main-container">
        <div className="second-container">
          <form className="form-container" onSubmit={handleSubmit}>
            ...
            <div>
              <p className="name-text-style">{nameForm}</p>
              <input
            ...
            <div>
              <p className="email-text-style">{emailForm}</p>
              <input
            ...
            <div>
              <p className="message-text-style">{messageForm}</p>
              <textarea
